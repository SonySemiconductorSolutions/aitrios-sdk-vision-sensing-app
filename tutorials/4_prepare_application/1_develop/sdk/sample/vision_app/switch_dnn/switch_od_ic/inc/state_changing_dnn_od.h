...
#ifndef _STATE_CHANGING_DNN_OD_H_
#define _STATE_CHANGING_DNN_OD_H_
...
/**
 * @class StateChangingDnnOd
 * @brief Implementation class of changing od dnn state
 */
class StateChangingDnnOd: public StateBase {
public:
    /**
     * @brief Constructor
     */
    StateChangingDnnOd(EvpController* evp,
...
#endif // _STATE_CHANGING_DNN_OD_H_
